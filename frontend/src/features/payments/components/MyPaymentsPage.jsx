...
export function MyPaymentsPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-textPrimary">Mis Pagos</h1>
        <p className="text-textSecondary text-sm mt-1">Historial de tus pagos</p>
      </div>
      ...
      <div className="card p-0 overflow-hidden">
        {loading ? (
          ...
          <EmptyState message="No tenés pagos registrados" />
        ) : (
